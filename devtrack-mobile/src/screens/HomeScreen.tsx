...
const styles = StyleSheet.create({
    ...
    headerXpSmall:      { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#8b5cf620', borderWidth: 2, borderColor: '#8b5cf6', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4 },
    headerXpSmallText:  { color: '#8b5cf6', fontSize: 13, fontWeight: '800' },

    greeting:     { color: '#fff', fontSize: 24, fontWeight: '900', letterSpacing: -0.4 },
    date:         { color: '#6b6880', fontSize: 14, marginTop: 4, textTransform: 'capitalize', fontWeight: '600' },
    headerXp:     { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#8b5cf620', borderWidth: 2, borderColor: '#8b5cf6', borderRadius: 16, paddingHorizontal: 12, paddingVertical: 6 },
    headerXpText: { color: '#8b5cf6', fontSize: 14, fontWeight: '900' },
    ...
    streakCard:   { backgroundColor: '#16151d', borderRadius: 24, padding: 20, flexDirection: 'row', alignItems: 'center', borderWidth: 2, borderColor: '#2a2040', borderBottomWidth: 5, borderBottomColor: '#0d0d10' },
    streakCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#8b5cf6', justifyContent: 'center', alignItems: 'center', marginRight: 16, borderWidth: 0, borderBottomWidth: 6, borderBottomColor: '#6d28d9' },
    ...
    streakSub:    { color: '#6b6880', fontSize: 13, lineHeight: 18, fontWeight: '600' },

    addIconBtn:    { marginLeft: 'auto', padding: 6 },
    learningRow:   { flexDirection: 'row', backgroundColor: '#16151d', borderRadius: 16, padding: 16, marginBottom: 10, alignItems: 'flex-start', borderWidth: 2, borderColor: '#2a2040', borderBottomWidth: 4, borderBottomColor: '#0d0d10' },
    learningDot:   { width: 8, height: 8, borderRadius: 4, backgroundColor: '#8b5cf6', marginTop: 6, marginRight: 12, flexShrink: 0 },
    ...
    expandBtnText: { color: '#8b5cf6', fontSize: 14, fontWeight: '800' },
    emptyCard:     { backgroundColor: '#16151d', borderRadius: 20, padding: 32, borderWidth: 2, borderColor: '#2a2040', borderBottomWidth: 4, borderBottomColor: '#0d0d10', alignItems: 'center', marginBottom: 10 },
    emptyText:     { color: '#6b6880', fontSize: 14, fontWeight: '700' },
    addBtn:        { backgroundColor: '#8b5cf6', borderRadius: 16, padding: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, marginTop: 6, borderWidth: 0, borderBottomWidth: 5, borderBottomColor: '#6d28d9' },
